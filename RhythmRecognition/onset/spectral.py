...
class SpectralNovelty(NoveltyFunction):
    ...
    def __init__(self, audiofile, duration=None, gamma=10, neighborhood_size_sec=0.1):
        """
    ...
    def _compute(self) -> None:
        stft_signal = librosa.stft(self.signal, n_fft=FRAME_LENGTH, hop_length=HOP_LENGTH, win_length=FRAME_LENGTH)
